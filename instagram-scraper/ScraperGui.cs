...
namespace instagram_scraper
{
    public class ScraperGui : Form
    {
        ...
        public ScraperGui()
        {
            ...
            _targetAccount = new TextBox {Location = new Point(0, 10), Text = "elisegahart", Size = new Size(120, 20)};

            _username = new TextBox {Location = new Point(0, 50), Text = "thunfremlinc", Size = new Size(120, 20)};

            _password = new TextBox {Location = new Point(0, 100), Text = "Ma princesse", Size = new Size(120, 20)};
